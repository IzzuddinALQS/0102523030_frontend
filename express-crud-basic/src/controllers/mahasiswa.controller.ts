...
export const getAllMahasiswa = async (req: Request, res: Response): Promise<any> => {
  try {
...
export const createMahasiswa = async (req: Request, res: Response): Promise<any> => {
  try {
...
export const updateMahasiswa = async (req: Request, res: Response): Promise<any> => {
  try {
    const { id } = req.params;
    const { nim, nama, prodi_id, angkatan } = req.body;
